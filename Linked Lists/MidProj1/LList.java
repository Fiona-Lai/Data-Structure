...
public class LList<T> implements ListInterface<T>
{
    ...
    public LList(LList<T> old) {
        ...
        Node oldCurrentNode = old.firstNode;
        Node newCurrentNode = null;
        
        while (oldCurrentNode != null) {
            Node newNode = new Node(oldCurrentNode.getData());
            
            if (newCurrentNode == null) {
                firstNode = newNode;
            } else {
                newCurrentNode.setNextNode(newNode);
            }
            
            newCurrentNode = newNode;
            oldCurrentNode = oldCurrentNode.getNextNode();
        }
    ...
    public boolean equals(LList<T> rhs) {
        ...
        while (currentNode != null && rhsCurrentNode != null) {
            if (!currentNode.getData().equals(rhsCurrentNode.getData())) {
                return false;
            }
            
            currentNode = currentNode.getNextNode();
            rhsCurrentNode = rhsCurrentNode.getNextNode();
        }
    ...
    /** Adds a new entry at a specified position within this list.
        ...
        The list鈥檚 size is increased by 1.
    ...
    /** Removes the entry at a given position from this list.
        ...
        next lower position within the list, and the list鈥檚 size is decreased by 1.
